...
&emsp;&emsp;鉴于各参赛队伍均已拥有自主产权的手语语料库（欢迎各参赛队伍提供语料，本评测团队和中国聋人协会手语研究与推广委员会审核后将一起公布），此次评测提供的语料库仅作为参考，以确保评测的全面性和公正性，此次评测提供的语料库规模至少为500个左右手语句子，涵盖100~200个手势，场景主要为服务行业，后期将根据合作单位标注进度逐步增加。
